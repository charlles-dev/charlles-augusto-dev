  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "tech-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(158 64% 52% / 0.5)"
          },
          "50%": {
            boxShadow: "0 0 40px hsl(158 64% 52% / 0.8)"
          }
        },
        "float": {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(158 64% 52% / 0.4)" },
          "50%": { boxShadow: "0 0 40px hsl(158 64% 52% / 0.8)" }
        }
      },
      animation: {
